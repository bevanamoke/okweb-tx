...
import { ArrowRight, CheckCircle2, ArrowLeft, LifeBuoy } from "lucide-react"
import type { Metadata } from "next"

export const metadata: Metadata = {
    title: "Odoo Support Services | OKS",
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                            Reliable Odoo Support
                        </h1>
                        <p className="text-xl md:text-2xl text-foreground/70 mb-8 leading-relaxed">
                            Keep your system running smoothly with our dedicated support packages.
                        </p>
                    ...
                    <div className="relative h-[400px] rounded-3xl bg-card border border-border p-8 overflow-hidden group">
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            ...
                            <div className="grid gap-4">
                                {["24/7 Server Monitoring", "Bug Fixes & Troubleshooting", "Performance Tuning"].map((benefit, i) => (
            ...
            <section className="container mx-auto px-4 max-w-4xl">
                <div className="mb-20">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {["24/7 Server Monitoring", "Bug Fixes & Troubleshooting", "Performance Tuning", "Security Updates", "User Query Resolution"].map((benefit, idx) => (
                ...
                <div className="bg-card border border-border rounded-3xl p-8 md:p-12 mb-20 relative overflow-hidden">
                    ...
                    <p className="text-xl text-foreground/70 leading-relaxed relative z-10">
                        Our support team is always on standby to resolve issues and keep your business running.
                    </p>
                </div>
