...
import { ArrowRight, CheckCircle2, ArrowLeft, GraduationCap } from "lucide-react"
import type { Metadata } from "next"

export const metadata: Metadata = {
    title: "Odoo Training Services | OKS",
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                            Expert Odoo Training
                        </h1>
                        <p className="text-xl md:text-2xl text-foreground/70 mb-8 leading-relaxed">
                            Maximize ROI by ensuring your team knows how to use the system effectively.
                        </p>
                    ...
                    <div className="relative h-[400px] rounded-3xl bg-card border border-border p-8 overflow-hidden group">
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            ...
                            <div className="grid gap-4">
                                {["End-User Training", "Administrator Training", "Developer Training"].map((benefit, i) => (
            ...
            <section className="container mx-auto px-4 max-w-4xl">
                <div className="mb-20">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {["End-User Training", "Administrator Training", "Developer Training", "Custom Documentation", "On-site or Remote Sessions"].map((benefit, idx) => (
                ...
                <div className="bg-card border border-border rounded-3xl p-8 md:p-12 mb-20 relative overflow-hidden">
                    ...
                    <p className="text-xl text-foreground/70 leading-relaxed relative z-10">
                        We provide hands-on training sessions tailored to different user roles within your organization.
                    </p>
                </div>
