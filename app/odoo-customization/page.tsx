...
import { ArrowRight, CheckCircle2, ArrowLeft, Sliders } from "lucide-react"
import type { Metadata } from "next"

export const metadata: Metadata = {
    title: "Odoo Customization Services | OKS",
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-xl md:text-2xl text-foreground/70 mb-8 leading-relaxed">
                            Don't settle for default. We build custom modules and workflows that match your exact business needs.
                        </p>
                    ...
                    <div className="relative h-[400px] rounded-3xl bg-card border border-border p-8 overflow-hidden group">
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            ...
                            <div className="grid gap-4">
                                {["Custom Module Development", "Workflow Automation", "Report Customization"].map((benefit, i) => (
            ...
            <section className="container mx-auto px-4 max-w-4xl">
                <div className="mb-20">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {["Custom Module Development", "Workflow Automation", "Report Customization", "UI/UX Modifications", "Specific Industry Logic"].map((benefit, idx) => (
                ...
                <div className="bg-card border border-border rounded-3xl p-8 md:p-12 mb-20 relative overflow-hidden">
                    ...
                    <p className="text-xl text-foreground/70 leading-relaxed relative z-10">
                        We analyze your unique requirements and build scalable, upgrade-safe customizations.
                    </p>
                </div>
